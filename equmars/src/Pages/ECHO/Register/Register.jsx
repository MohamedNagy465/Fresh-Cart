 ...
 const validationSchema = object({
  name: string()
    ...
    .matches(/^[A-Za-z ]+$/, "Name must contain only letters"), // الاسم ميقبلش أرقام أو رموز
  ...
  phone: string()
    ...
    .matches(/^01[0125][0-9]{8}$/, "Phone number must be a valid Egyptian number") // الرقم ميقبلش حروف
});
        ...
        <form className='space-y-2' onSubmit={formik.handleSubmit}>
          ...
          <div className="flex flex-col space-y-2 ">
            ...
            {formik.errors.phone && formik.touched.phone && (
              <p className='text-red-500 font-semibold'>{formik.errors.phone}</p>
            )}
          </div>
